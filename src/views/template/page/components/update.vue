...
export default {
    ...
    methods: {
        // 根据ID获取模板详情信息
        getTemplateInfo() {
            post("/api/weiadm/v1/wapage/get/id", {
                waPageId: this.$route.params.pageId
            })
                .then(res => {
                    this.moduleList = res.data.controls;
        ...
        async saveTemplate() {
            ...
            let res = await post("/api/weiadm/v1/wapage/update", {
            ...
            if(res.status == 0) {
                ...
                setTimeout(()=> {
                    this.$router.push({name:'template_page_index'})
                },2000)
            }
        },
        // 图片上传 => 图文广告 & 导航菜单
